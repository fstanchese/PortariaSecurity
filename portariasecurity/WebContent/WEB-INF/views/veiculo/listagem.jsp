...
<html>
	...
	<body>
		<div class="container">
			...
			<section id="secao-veiculos">
				<jsp:include page="tabela-veiculos.jsp"/>
				<input id="csrf" name="_csrf" type="hidden" value="${_csrf.token}">
			</section>
			<jsp:include page="modal-veiculos.jsp"/>
		</div>
		<script type="text/javascript" src="${path}/static/js/jquery.min.js"></script>
		<script type="text/javascript" src="${path}/static/bootstrap/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="${path}/static/js/jquery.bootstrap-growl.min.js"></script>
		<script type="text/javascript" src="${path}/static/js/veiculos.js"></script>
