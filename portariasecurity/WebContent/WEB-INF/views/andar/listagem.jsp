...
<html>
	...
	<body>
		<div class="container">
			...
			<section id="secao-andares">
				<jsp:include page="tabela-andares.jsp"/>
			</section>
			<jsp:include page="modal-andares.jsp"/>
		</div>
		<script type="text/javascript" src="${path}/static/js/jquery.min.js"></script>
		<script type="text/javascript" src="${path}/static/bootstrap/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="${path}/static/js/jquery.bootstrap-growl.min.js"></script>
		<script type="text/javascript" src="${path}/static/js/andares.js"></script>
